...
export default function RewardPopup({ activityName, onClaim, onPlayAgain }: RewardPopupProps) {
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1 shrink-0">
          ...
          <p className="text-xs font-bold text-slate-500 mt-2 max-w-xs leading-relaxed">
            Great job! You finished the activity. Keep going to finish all activities!
          </p>
        </div>
        ...
        <div className="flex flex-row items-center gap-3 w-full justify-center">
          ...
          <motion.button
            ...
            className="active:translate-y-[2px] active:shadow-[0_2px_0_rgba(0,0,0,0.15)] transition-all uppercase shrink-0 tracking-wide"
          >
            Play Again
          </motion.button>
